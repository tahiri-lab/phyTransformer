...
model_checkpoint = 'dmis-lab/biobert-base-cased-v1.1-mnli'
# model_checkpoint = 'roberta-base' # you can alternatively use roberta-base but this model is bigger thus training will take longer

# Préparer les labels
label_list = tokenized_datasets["train"].features["protein_name"].names

# Convertir les labels en IDs
def encode_labels(example):
    example["labels"] = label_list.index(example["protein_name"])
    return example
